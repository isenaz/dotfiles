# Generated by Powerlevel10k configuration wizard on 2024-01-04 at 18:09 JST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # <<default is 32 but changed to 64>>
  ...
  typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=alwayd
